  ...
  return (
    <div className="w-full py-12 px-6 md:px-20 bg-[#F6F7FC]">
      <div className="max-w-6xl mx-auto text-center mb-8">
        ...
        <h2 className="text-[26px] font-bold text-[#EC3237]">NEWS & UPDATES</h2>
      </div>
          ...
          {newsData.map((item) => (
            ...
            >
              <div className="w-[380px] h-48">
                ...
                />
                <div className="absolute top-0 left-4 text-[#FFFFFF] text[12px] px-3.5 py-1 rounded-r-[50px] bg-gradient-to-r from-[#193A65]  to-[#EC3237]">
                  {item.category}
                </div>
              </div>

              <div className="px-4 pt-4">
                <h3 className="text-[14px] font-semibold text-[#EC3237] mb-2">
                  {item.title}
                </h3>
      ...
      <div className="text-center mt-8 text-[14px]">
        ...
        <button className="inline-block px-6 py-2 border-2 border-[#EC3237] text-[#EC3237] rounded-md hover:bg-[#EC3237] hover:text-white transition-colors duration-300">
          View All Updates
        </button>
        </Link>
      </div>
