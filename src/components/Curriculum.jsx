...
// NEW: Write hash when clicking a tab
useEffect(() => {
  if (activeTab) {
...
Cambridge qualifications are well respected globally and open doors to universities and career opportunities in India and abroad. Over 1,400 universities worldwide recognise these certifications, including all universities in the UK, more than 600 in the United States (such as Ivy League institutions), and leading institutions in Canada, Australia, Singapore, South Africa, Germany, and the Netherlands. A Cambridge qualification carries long-term value and is highly regarded in both academic and professional fields.
        ...
        {activeTab === "igcse" && (
          <div id="igcse"  className="animate-fadeIn">
            ...
            <div className="space-y-6 text-[15px] md:text-[16px] text-gray-800 leading-relaxed max-w-5xl">
              <div className="bg-gradient-to-r from-[#0F4976] to-[#d62a2f] text-white p-6 md:p-8 rounded-lg mb-8">
...
The Cambridge IGCSE is the most widely chosen international qualification for students aged 14–16. At Ecole Globale, students can opt for either the CBSE or CI curriculum when entering Grade 9. The two-year IGCSE programme (Classes IX and X) at Ecole offers a balanced range of subjects designed to challenge students academically while nurturing diverse interests and abilities.
              ...
              <h3 className="font-semibold text-[22px] md:text-[26px] text-[#0F4976] mt-10 mb-6">
                Subject Groups at Ecole Globale
              </h3>

              <div className="space-y-4">
                <div className="bg-white p-6 rounded-lg shadow-lg border-l-4 border-[#0F4976]">
                  <p className="font-semibold text-[18px] text-[#0F4976] mb-3">Group 1: Languages</p>
                ...
                <div className="bg-white p-6 rounded-lg shadow-lg border-l-4 border-[#0F4976]">
                  <p className="font-semibold text-[18px] text-[#0F4976] mb-3">Group 2: Humanities</p>
                  <p className="text-gray-700">
                ...
                <div className="bg-white p-6 rounded-lg shadow-lg border-l-4 border-[#0F4976]">
                  <p className="font-semibold text-[18px] text-[#0F4976] mb-3">Group 3: Sciences</p>
                  <p className="text-gray-700">
                ...
                <div className="bg-white p-6 rounded-lg shadow-lg border-l-4 border-[#0F4976]">
                  <p className="font-semibold text-[18px] text-[#0F4976] mb-3">Group 4: Mathematics</p>
                  <p className="text-gray-700">
                ...
                <div className="bg-white p-6 rounded-lg shadow-lg border-l-4 border-[#0F4976]">
                  <p className="font-semibold text-[18px] text-[#0F4976] mb-3">Group 5: Creative and Vocational</p>
                  <p className="text-gray-700">
...
Why Choose Cambridge A Levels?
              ...
              <div className="grid md:grid-cols-2 gap-6 my-8">
                <div className="bg-white p-6 rounded-lg shadow-lg border-t-4 border-[#0F4976]">
                ...
                <div className="bg-white p-6 rounded-lg shadow-lg border-t-4 border-[#0F4976] md:col-span-2">
              ...
              <div className="bg-gray-50 p-6 md:p-8 rounded-lg border-l-4 border-[#0F4976] mb-8">
                <p className="mb-4">
                  <span className="font-semibold text-[#0F4976]">AS Level:</span> Students select 4-5 subjects
                </p>
                <p>
                  <span className="font-semibold text-[#0F4976]">A Level:</span> Students select 3-4 subjects
                </p>
              </div>

              <h3 className="font-semibold text-[20px] md:text-[22px] text-[#0F4976] mb-4">
                Available Subjects
              </h3>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  {["English", "Physics", "Chemistry", "Biology", "Economics", "Business", "Accounts", "History", "Psychology", "Information Technology", "Mathematics"].map((subject, index) => (
                    <div key={index} className="flex items-center">
                      <div className="w-2 h-2 bg-[#0F4976] rounded-full mr-3"></div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white p-6 rounded-lg shadow-lg border-l-4 border-[#0F4976]">
                  ...
                  <p className="text-[14px] text-gray-700 mb-2">Grade scale: <span className="font-semibold text-[#0F4976]">A* to E</span></p>
